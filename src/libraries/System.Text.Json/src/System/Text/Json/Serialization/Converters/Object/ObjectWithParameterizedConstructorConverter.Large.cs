...
namespace System.Text.Json.Serialization.Converters
{
    ...
    internal sealed class LargeObjectWithParameterizedConstructorConverter : ObjectWithParameterizedConstructorConverter
    {
        ...
        protected override object CreateObject(ref ReadStackFrame frame)
        {
            ...
            var createObject = (JsonClassInfo.ParameterizedConstructorDelegate<object?>?)frame.JsonClassInfo.CreateObjectWithParameterizedCtor;
        ...
        protected override void InitializeConstructorArgumentCaches(ref ReadStack state, JsonSerializerOptions options)
        {
            ...
            {
                classInfo.CreateObjectWithParameterizedCtor = options.MemberAccessorStrategy.CreateParameterizedConstructor<object>(ConstructorInfo!);
            }
