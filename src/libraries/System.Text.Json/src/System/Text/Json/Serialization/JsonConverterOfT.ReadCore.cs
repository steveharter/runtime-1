    ...
    public partial class JsonConverter<T>
    {
            ...
            ref ReadStack state)
        {
            try
            {
                ...
                JsonPropertyInfo jsonPropertyInfo = jsonClassInfo.PolicyProperty;
                ...
                if (success)
                {
                    ...
                    // The reader returns 'false' even when this is the final block and all whitespace is read.
            ...
            {
                NotSupportedException newEx = ThrowHelper.GetNotSupportedException(state, reader, ex);
                if (newEx == ex)
                {
