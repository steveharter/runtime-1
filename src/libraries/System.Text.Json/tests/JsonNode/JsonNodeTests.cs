...
namespace System.Text.Json.Node.Tests
{
    public static partial class JsonNodeTests
    {
        ...
        public static void JsonTypes_Deserialize()
        {
            ...
            Assert.IsType<JsonObject>(JsonNode.ParseUtf8Bytes(ToUtf8("{}")));
            ...
            Assert.IsType<JsonArray>(JsonNode.ParseUtf8Bytes(ToUtf8("[]")));
            Assert.IsType<JsonElement>(JsonSerializer.Deserialize<object>("[]", options));
            ...
            Assert.IsAssignableFrom<JsonValue>(JsonNode.ParseUtf8Bytes(ToUtf8("true")));
            ...
            Assert.IsAssignableFrom<JsonValue>(JsonNode.ParseUtf8Bytes(ToUtf8("0")));
            ...
            Assert.IsAssignableFrom<JsonValue>(JsonNode.ParseUtf8Bytes(ToUtf8("1.2")));
            ...
            Assert.IsAssignableFrom<JsonValue>(JsonNode.ParseUtf8Bytes(ToUtf8("\"str\"")));
