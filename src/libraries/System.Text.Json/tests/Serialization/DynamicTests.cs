...
{
    public static class DynamicTests_DefaultConverters
    {
        public const string Json = "{\"MyString\":\"Hello\",\"MyBoolean\":true,\"MyArray\":[1,2],\"MyInt\":42,\"MyDouble\":4.2,\"MyDateTime\":\"2020-07-08T00:00:00\",\"MyObject\":{\"MyString\":\"World\"}}";
        ...
        public static void ExpandoObject()
        {
            ...
            Assert.Equal(7, ((IDictionary<string, object>)expando).Keys.Count);
